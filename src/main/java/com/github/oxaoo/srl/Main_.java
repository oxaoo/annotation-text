...
public class Main_ {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Main_ demo = new Main_(pipelineOptions); // replace with "args" if options from command line are to be used
    ...
    public Main_(String[] commandlineoptions) throws ZipException, ClassNotFoundException, IOException {
